...
namespace osu.Game.Rulesets.Difficulty
{
    ...
    public class DifficultyAttributes
    {
        ...
        protected const int ATTRIB_ID_AIM_DIFFICULTY_ATTRIB_MU = 23;
        protected const int ATTRIB_ID_AIM_DIFFICULTY_ATTRIB_SIGMA = 25;
        protected const int ATTRIB_ID_AIM_DIFFICULTY_ATTRIB_V = 27;
